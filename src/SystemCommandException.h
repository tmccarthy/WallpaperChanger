...
#ifndef SYSTEMCOMMANDEXCEPTION_H
#define	SYSTEMCOMMANDEXCEPTION_H

#include <exception>
#include <string>

class SystemCommandException : public std::exception {
public:
    /**
     * Constructor, associates the given message with this exception.
     * @param message
     */
    SystemCommandException(std::string message);
...
#endif	/* SYSTEMCOMMANDEXCEPTION_H */
