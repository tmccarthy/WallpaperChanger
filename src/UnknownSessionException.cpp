...
const std::string UnknownSessionException::DEFAULT_MESSAGE 
= "Unrecognised desktop session";

UnknownSessionException::UnknownSessionException(
        std::string message = DEFAULT_MESSAGE) : message_(message) {
}

UnknownSessionException::~UnknownSessionException() throw () {
}

const char * UnknownSessionException::what() const throw() {
